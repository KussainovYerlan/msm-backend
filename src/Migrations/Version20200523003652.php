 ...
 */
final class Version20200523003652 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, status VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lesson (id INT AUTO_INCREMENT NOT NULL, master_id INT NOT NULL, platform_id INT NOT NULL, sub_group_id INT NOT NULL, name VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, periodicity VARCHAR(100) NOT NULL, starts_at TIME NOT NULL, ends_at TIME NOT NULL, INDEX IDX_F87474F313B3DB11 (master_id), INDEX IDX_F87474F3FFE6496F (platform_id), INDEX IDX_F87474F344FB371E (sub_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, platform_id INT NOT NULL, master_id INT NOT NULL, date DATE NOT NULL, description LONGTEXT NOT NULL, name VARCHAR(255) NOT NULL, ends_at TIME NOT NULL, starts_at TIME NOT NULL, INDEX IDX_3BAE0AA7FFE6496F (platform_id), INDEX IDX_3BAE0AA713B3DB11 (master_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson DROP FOREIGN KEY FK_F87474F313B3DB11');
